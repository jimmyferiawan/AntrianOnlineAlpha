<?php
    if(isset($_POST['pasien_submit'])) {
        ...
        $sql = "INSERT INTO pasien (ID_pasien, username_pasien, password_pasien, nama_pasien, jenis_kelamin_pasien, alamat_pasien, no_hp_pasien, no_bpjs_pasien) VALUES ('$nik', '$uname', '$pass', '$nama', '$jenis_kelamin', '$alamat', '$no_hp', '$bpjs')";
